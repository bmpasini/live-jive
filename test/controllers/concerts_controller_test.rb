...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { buy_tickets_website: @concert.buy_tickets_website, ccity: @concert.ccity, cdate: @concert.cdate, ctime: @concert.ctime, location_name: @concert.location_name }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { buy_tickets_website: @concert.buy_tickets_website, ccity: @concert.ccity, cdate: @concert.cdate, ctime: @concert.ctime, location_name: @concert.location_name }
    assert_redirected_to concert_path(assigns(:concert))
  end
